                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="jml" class="form-control" placeholder="" oninput="validateJumlah()">
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function checkForm() {
        ...
        if (tglmasuk == "") {
            ...
            validasi('Jumlah Masuk wajib di isi dengan angka valid!', 'warning');
            $("input[name='jml']").addClass('is-invalid');
            setLoading(false);
            return false;
        } else if (isNaN(jml) || jml <= 0) {
            validasi('Jumlah Masuk harus berupa angka lebih dari nol!', 'warning');
            $("input[name='jml']").addClass('is-invalid');
            setLoading(false);
            return false;
        } else {
