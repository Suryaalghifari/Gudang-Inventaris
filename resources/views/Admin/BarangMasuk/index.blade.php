...
<script>
    ...
    var month = ('0' + (now.getMonth() + 1)).slice(-2); // bulan dimulai dari 0, jadi tambahkan 1
    var day = ('0' + now.getDate()).slice(-2);

    var id = "BM-" + day + month + year;
    $("input[name='bmkode']").val(id);
    }
    ...
    function hapus(data) {
        ...
        $("#vbm").html("Kode  " + "<b>" + data.bm_kode + "</b>");
    }
